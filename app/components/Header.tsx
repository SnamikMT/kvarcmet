...
export default function Header() {
  return (
    <header className="w-full bg-[#0F172A] fixed top-0 left-0 z-50 shadow-md">
      <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center space-x-4">
          ...
          <button className="bg-[#4ADE80] px-4 py-2 rounded-lg font-semibold hover:brightness-110 transition">
            Отправить чертёж
          </button>
        </div>
      </div>
